...
2. Copy the .devcontainer directory into the VS Code project directory you want to containerize.
2. Open your project directory in VS Code on Windows.
3. Hit CTRL-SHIFT P, and find and run Build and Reopen in Container. Note VS Code may also automatically detect the 
   .devcontainer directory and ask if you want to Build and Reopen.
...
7. Once 6. succeeds, you can edit the Dockerfile to install the toolchain you want and and add additional plugins you want 
   to the devctonainer.json file. 
